...
public class CardsController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardsDto> fetchAccountDetails(@RequestParam @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                               String mobileNumber){
    ...
    @Operation(
            ...
            description = "Get Contact information details that is delayed into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
