...
@Tag(
        ...
        description = "Crud Rest Apis in bank "
)
@RestController
...
public class AccountsController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ResponseDto> createAccount(@Valid @RequestBody CustomerDto custommerDto) {
        iAccountsService.createAccount(custommerDto);
    ...
    @Operation(
            ...
            description = "Get build information that is delayed into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "Get Java version details that is delayed into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
